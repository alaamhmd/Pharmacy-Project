...
namespace Pharmacy_Project
{
    public partial class Form13 : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'pharmacy_DBDataSet.sell' table. You can move, or remove it, as needed.
            this.sellTableAdapter.Fill(this.pharmacy_DBDataSet.sell);
        ...
        {
            this.sellBindingSource.RemoveCurrent();
        }
